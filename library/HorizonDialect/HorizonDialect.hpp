/** @file
 *  @brief MAVLink comm protocol generated from HorizonDialect.xml
...
/** @brief Flight phase of the rocket. */
enum class ROCKET_STATE_TYPE : uint8_t
{
    IDLE=0, /* On the pad, not armed. | */
    CALIBRATED=1, /* Sensors calibrated, ready for launch. | */
    THRUSTING=2, /* Motor burning, ascending under power. | */
    COASTING=3, /* Motor burnout, ascending on momentum. | */
    DROGUE=4, /* Drogue parachute deployed. | */
    MAIN=5, /* Main parachute deployed. | */
    TOUCHDOWN=6, /* Landed. | */
};

//! ROCKET_STATE_TYPE ENUM_END
constexpr auto ROCKET_STATE_TYPE_ENUM_END = 7;
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_flight_states.hpp"
#include "./mavlink_msg_payload_temperature.hpp"
#include "./mavlink_msg_cosmic_radiation.hpp"
