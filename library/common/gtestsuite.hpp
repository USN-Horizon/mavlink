...
TEST(common, GIMBAL_DEVICE_INFORMATION)
{
    ...
    packet_in.cap_flags2 = 963505004;
    ...
    EXPECT_EQ(packet1.yaw_max, packet2.yaw_max);
    EXPECT_EQ(packet1.gimbal_device_id, packet2.gimbal_device_id);
    EXPECT_EQ(packet1.cap_flags2, packet2.cap_flags2);
}
...
TEST(common_interop, GIMBAL_DEVICE_INFORMATION)
{
    ...
    EXPECT_EQ(packet_in.yaw_max, packet2.yaw_max);
    EXPECT_EQ(packet_in.gimbal_device_id, packet2.gimbal_device_id);
    EXPECT_EQ(packet_in.cap_flags2, packet2.cap_flags2);
...
TEST(common, AIRSPEED)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::AIRSPEED packet_in{};
    packet_in.id = 163;
    packet_in.airspeed = 17.0;
    packet_in.temperature = 17651;
    ...
    mavlink::common::msg::AIRSPEED packet1{};
    mavlink::common::msg::AIRSPEED packet2{};
...
TEST(common, GLOBAL_POSITION_SENSOR)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::GLOBAL_POSITION_SENSOR packet_in{};
    packet_in.target_system = 113;
    packet_in.target_component = 180;
    packet_in.id = 247;
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.processing_time = 963497880;
    packet_in.source = 58;
    packet_in.flags = 125;
    packet_in.lat = 963498088;
    packet_in.lon = 963498296;
    packet_in.alt_ellipsoid = 157.0;
    packet_in.alt = 185.0;
    packet_in.eph = 213.0;
    packet_in.epv = 241.0;

    mavlink::common::msg::GLOBAL_POSITION_SENSOR packet1{};
    mavlink::common::msg::GLOBAL_POSITION_SENSOR packet2{};
    ...
    EXPECT_EQ(packet1.id, packet2.id);
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.processing_time, packet2.processing_time);
    EXPECT_EQ(packet1.source, packet2.source);
    EXPECT_EQ(packet1.flags, packet2.flags);
    EXPECT_EQ(packet1.lat, packet2.lat);
    EXPECT_EQ(packet1.lon, packet2.lon);
    EXPECT_EQ(packet1.alt_ellipsoid, packet2.alt_ellipsoid);
...
#ifdef TEST_INTEROP
TEST(common_interop, GLOBAL_POSITION_SENSOR)
{
    mavlink_message_t msg;
    ...
    mavlink_global_position_sensor_t packet_c {
    ...
    mavlink_msg_global_position_sensor_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.id, packet2.id);
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.processing_time, packet2.processing_time);
    EXPECT_EQ(packet_in.source, packet2.source);
    EXPECT_EQ(packet_in.flags, packet2.flags);
    EXPECT_EQ(packet_in.lat, packet2.lat);
    EXPECT_EQ(packet_in.lon, packet2.lon);
    EXPECT_EQ(packet_in.alt_ellipsoid, packet2.alt_ellipsoid);
...
TEST(common, PARAM_ERROR)
{
    ...
    mavlink::common::msg::PARAM_ERROR packet_in{};
    packet_in.target_system = 139;
    packet_in.target_component = 206;
    packet_in.param_id = to_char_array("EFGHIJKLMNOPQRS");
    packet_in.param_index = 17235;
    ...
    mavlink::common::msg::PARAM_ERROR packet1{};
    mavlink::common::msg::PARAM_ERROR packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, PARAM_ERROR)
{
    mavlink_message_t msg;
    ...
    mavlink_param_error_t packet_c {
    ...
    mavlink_msg_param_error_encode(1, 1, &msg, &packet_c);
...
TEST(common, FIGURE_EIGHT_EXECUTION_STATUS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::FIGURE_EIGHT_EXECUTION_STATUS packet_in{};
    packet_in.time_usec = 93372036854775807ULL;
    ...
    mavlink::common::msg::FIGURE_EIGHT_EXECUTION_STATUS packet1{};
    mavlink::common::msg::FIGURE_EIGHT_EXECUTION_STATUS packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, FIGURE_EIGHT_EXECUTION_STATUS)
{
    mavlink_message_t msg;
...
TEST(common, RELAY_STATUS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::RELAY_STATUS packet_in{};
    packet_in.time_boot_ms = 963497464;
    packet_in.on = 17443;
    packet_in.present = 17547;

    mavlink::common::msg::RELAY_STATUS packet1{};
    mavlink::common::msg::RELAY_STATUS packet2{};
    ...
    EXPECT_EQ(packet1.time_boot_ms, packet2.time_boot_ms);
    EXPECT_EQ(packet1.on, packet2.on);
    EXPECT_EQ(packet1.present, packet2.present);
}

#ifdef TEST_INTEROP
TEST(common_interop, RELAY_STATUS)
{
    mavlink_message_t msg;
    ...
    mavlink_relay_status_t packet_c {
    ...
    mavlink_msg_relay_status_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.time_boot_ms, packet2.time_boot_ms);
    EXPECT_EQ(packet_in.on, packet2.on);
    EXPECT_EQ(packet_in.present, packet2.present);
